...
<article id="home_modified">
	<div class="container">
		...
		<div style="margin: 15px;">	
			<h4>Terms of Use</h4>
			<p>This site is for educational purposes only, and its sole purpose is for users to test their personal network(s). Using it for any motive(s) other than security-analysis is strictly prohibited, and is also a violation of our Terms Of Service agreement, which is punishable by law.</p>
			<p>If we suspect that any individual user is inappropriately using our security-analysis software, we reserve the right to ban, delete, or otherwise disable the given user's account, with or without expressed reasoning. If an account is banned, deleted, or disabled in any way, whatsoever, the owner of the account may or may not be notified. </p>
			<p>Inappropriate usage (also referred to as "abuse") includes, but is not limited to, sharing accounts with multiple users without having purchased a sharing license, testing the same webservers repeateldy, "spam testing" (testing with hardly any time between tests), repeatedly and excessively using the analysis resources, using the software excessively, resale of accounts without explicit, written permission, and using the software on any server(s) not owned by the user initiating the security-analysis tests. </p>
			<p>No refunds will be given. You forfeit your right to a refund by accepting these terms, and under no circumstance will you regain this right. </p>
			<p>Lastly, we reserve the right to update, modify, or otherwise change any portion of, or the entire Terms Of Service, at any given time, with or without warning to any of its users. If the Terms Of Service are changed in any way, and a user is found to be in violation the new version of the Terms Of Service, they still can be held accountable, with staff discretion, for any and all actions committed or performed, and logged under their account alias.</p>
		<p><a href="register.php"><INPUT TYPE="button" VALUE="Accept"></a> <a href="http://fbi.gov/"><INPUT TYPE="button" VALUE="Decline" onClick="register.php"></a></p>
		</div>
